#!/usr/bin/env python
"""
Script to visualize the copylines and their proper T-shape.
"""
...
def main():
    """Create a visualization of all copylines."""
    ...
    # Save the figure
    plt.tight_layout()
    plt.savefig("copylines_visualization.png", dpi=300)
    print("Visualization saved to 'copylines_visualization.png'")
